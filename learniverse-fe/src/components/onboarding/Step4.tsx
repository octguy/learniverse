// File: src/components/onboarding/Step4.tsx
"use client"
...
export default function Step4({
  ...
  const canFinish = selectedTags.length <= MAX_SELECTION
  ...
  return (
      <div className="flex flex-col justify-between bg-gradient-to-b from-[#f6f6ff] to-white w-full max-w-[1250px] h-full min-h-[60vh] lg:min-h-[50vh] xl:min-h-[45vh] 2xl:min-h-[40vh] rounded-xl p-10">
          ...
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-gray-500 text-sm">
                Chọn tối đa <strong>5</strong> môn học mà bạn muốn cải thiện (có thể bỏ qua).
              </p>
            </div>
              ...
              return (
                  <div
                      ...
                      className={cn(
                          ...
                          isSelected ? "ring-2 ring-blue-500 bg-blue-50" : isDisabled ? "opacity-50 cursor-not-allowed" : "bg-white hover:bg-gray-50 hover:shadow-md"
                      )}
                  >
        ...
        <div className="flex justify-end gap-4 mt-10">
          <Button variant="outline" onClick={onPrev} className="text-blue-600 border-blue-500 hover:bg-blue-50 rounded">← Quay lại</Button>
          <Button
              className={cn("bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded", !canFinish && "opacity-50 cursor-not-allowed")}
              disabled={!canFinish}
              onClick={onFinish}
          >
            Hoàn tất ✓
